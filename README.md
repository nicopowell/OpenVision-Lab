...
- Four processors: grayscale, Gaussian blur, binary threshold, and Canny edge
  detection.
- Per-step parameters (blur kernel size and sigma, threshold value, and Canny
  hysteresis thresholds and aperture).
